...
![8.25 double 64 expamle](./js%20是如何存储数字的/f57192d6-0ec2-4ae9-af18-5c8393ad2ee1.png)
...
![demo1 png](./js%20是如何存储数字的/image-20220623220709116.png)

0.2同理，也是循环二进制，存储结果为：

![demo2 png](./js%20是如何存储数字的/image-20220623221005089.png)
